		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<a href="{{ route('books.display', $book->id) }}" class="icon warning" title="{{ __('Book has no image linked to it ! Can\'t be displayed on front page.') }}"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
