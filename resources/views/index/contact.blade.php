<x-index-layout>
	...
	<form class="text-custom grid md:grid-cols-9 xl:gap-4 xl:items-center" action="#" method="post" enctype="multipart/form-data">
		...
		<input class="md:col-start-2 md:col-span-7 xl:col-span-3 shadow-md" id="email" name="email" type="text">
		...
		<input class="md:row-start-4 md:col-start-2 md:col-span-7 xl:row-start-2 xl:col-start-4 xl:col-span-3 shadow-md" id="subject" name="subject" type="text">
		...
		<textarea class="h-72 md:row-start-6 md:col-start-2 md:col-span-7 xl:row-start-3 xl:col-start-4 xl:col-span-3 md:h-96 shadow-md" id="message" name="message"></textarea>
		<span class="my-4 md:row-start-7 md:col-start-2 md:col-span-7 xl:mt-0 text-right xl:row-start-4 xl:col-start-6 xl:col-span-1">
			<button class="base-link">{{ __('Envoyer') }}</button>
		</span>
	</form>
